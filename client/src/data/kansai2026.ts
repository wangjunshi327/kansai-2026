...
export const places: KansaiPlace[] = [
  ...
  { id: 'kobe-hotel', name: '神户美利坚公园东方大酒店', city: '神户', category: '住宿', lat: 34.6806, lng: 135.1885, address: '神户港美利坚公园', summary: '10 月 2 日至 4 日入住，位于神户港边', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kobe_Meriken_Park01bs3200.jpg?width=1280', imageAlt: '神户美利坚公园与港区天际线' },
  ...
  { id: 'maiko', name: '舞子公园', city: '舞子', category: '景点', lat: 34.6316, lng: 135.0344, address: '神户市垂水区东舞子町', summary: '眺望濑户内海、淡路岛和明石海峡大桥', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Akashi_Kaikyo_Bridge_from_Maiko_Station.JPG?width=1280', imageAlt: '从舞子公园方向看明石海峡大桥' },
  ...
  { id: 'arima-town', name: '有马温泉街', city: '有马温泉', category: '景点', lat: 34.7973, lng: 135.2481, address: '神户市北区有马町', summary: '买伴手礼、喝咖啡和轻松散步的温泉小镇', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kin-no-yu_Arima_Onsen01s3200.jpg?width=1280', imageAlt: '神户有马温泉街的金之汤公共浴场' },
  ...
  { id: 'namba', name: '难波与心斋桥', city: '大阪', category: '购物', lat: 34.6705, lng: 135.5013, address: '大阪市中央区难波、心斋桥一带', summary: '购物、咖啡、晚餐和城市散步区域', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Shinsaibashi_Suji_Shopping_Street_Osaka_Japan_by_Don_Ramey_Logan.jpg?width=1280', imageAlt: '大阪心斋桥筋商店街' },
  { id: 'pokemon-osaka-dx', name: 'Pokémon Center OSAKA DX', city: '大阪', category: '购物', lat: 34.6732, lng: 135.5013, address: '大丸心斋桥店 本馆 9F｜大阪府大阪市中央区心斋桥筋1-7-1', summary: '帮同事购买宝可梦卡牌的购物任务', website: 'https://www.pokemon.co.jp/shop/', image: 'https://www.pokemon.co.jp/img/sp/pokecen_osakadx_2019/pic01.jpg', imageAlt: 'Pokémon Center OSAKA DX 官方店内照片' },
...
export const itinerary: ItineraryItem[] = [
  ...
  { id: 'd2-8', dayId: 'd2', time: '晚餐后', title: '返回酒店附近观看神户港烟花', placeId: 'meriken', kind: '景点', note: '看完烟花后不再安排其他活动。', showImage: true },
